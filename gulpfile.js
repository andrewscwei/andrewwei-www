...
'use strict';
// generated on 2015-05-26 using generator-vars-jekyll 0.3.8
...
{
    return gulp.src(['.generated/assets/**/*.'+FONTS_PATTERN])
...
gulp.task('styles', function()
{
    return merge
    (
        gulp.src('.generated/assets/css/*.'+STYLES_PATTERN)
        ...
        gulp.src(['.generated/assets/vendor/**/*.css'])
...
gulp.task('static', ['images', 'videos', 'fonts', 'styles', 'scripts', 'extras'], function()
{
    ...
    (
        ...
        gulp.src(['.tmp/assets/**/*.'+IMAGES_PATTERN, '.tmp/assets/**/*.'+VIDEOS_PATTERN, '.tmp/assets/**/*.'+FONTS_PATTERN, '.tmp/assets/**/*.'+STYLES_PATTERN, '.tmp/assets/**/*.'+SCRIPTS_PATTERN])
            .pipe($.if(!skipRev(), $.rev()))
...
gulp.task('serve', function()
{
    ...
    if (debug())
    {
        ...
        gulp.watch('app/**/*.'+VIDEOS_PATTERN, function() { sequence('generate', 'videos', browserSync.reload); });
    ...
    else
    {
        ...
        gulp.watch('app/**/*.'+VIDEOS_PATTERN, function() { sequence('generate', 'build', browserSync.reload); });
